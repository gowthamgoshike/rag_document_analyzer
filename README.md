...
├── generate_word_doc.py         # Utility script for pipeline testing data
...
* **Port Collision Avoidance:** Explicitly targets port `9000` for the REST API interface to bypass standard macOS process locks.
